...
public  ResponseEntity<List<Product>> findAll(){
    ...
    @GetMapping("/savewithdto")
    public ResponseEntity<ProductCreateResponseDto> saveProductWithDto(String name , double price, String date){
        ProductCreateResponseDto pcrd=productService.saveProductWithDto(Product.builder().name(name).price(price).expirationDate(LocalDate.parse(date))
                .build());


        return ResponseEntity.ok(pcrd);
